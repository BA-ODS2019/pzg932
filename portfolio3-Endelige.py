...
optæl_årstal = df['acqdate'].value_counts(normalize=True).mul(100).round(1) #får kun optællingerne
...
# Opgave 6: Visualisering af den nye dataframe. Dette fremvises i JupiterLab.
